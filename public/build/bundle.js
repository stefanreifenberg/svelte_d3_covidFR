...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			p.textContent = "Source : covid19germany R package";
    			attr_dev(p, "class", "svelte-rolo3k");
    			add_location(p, file$2, 17, 3, 340);
    			attr_dev(div, "class", "chart svelte-rolo3k");
    			add_location(div, file$2, 15, 2, 271);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "Daily confirmed Covid Cases Freiburg";
    			t1 = space();
    			main = element("main");
    			if (if_block) if_block.c();
    			attr_dev(h2, "class", "svelte-rolo3k");
    			add_location(h2, file$2, 11, 0, 193);
    			attr_dev(main, "class", "svelte-rolo3k");
    			add_location(main, file$2, 13, 0, 240);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
