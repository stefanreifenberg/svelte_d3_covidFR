...
var app = (function () {
    ...
    /* src/Axis.svelte generated by Svelte v3.31.0 */
    const file = "src/Axis.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g_1, file, 32, 0, 591);
    		},
    ...
    /* src/LineChartCovid.svelte generated by Svelte v3.31.0 */
    const file$1 = "src/LineChartCovid.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	let path1;
    	let path1_d_value;
    	let path1_stroke_width_value;
    	let path1_intro;
    	let path2;
    	let path2_d_value;
    	let path2_stroke_width_value;
    	let path2_intro;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "d", path0_d_value = /*lineGenerator_dead*/ ctx[4](/*data*/ ctx[0]));
    			attr_dev(path0, "stroke", "#e56b6f");
    		...
    		p: function update(ctx, [dirty]) {
    			const axis0_changes = {};
    			if (dirty & /*xScale*/ 2) axis0_changes.scale = /*xScale*/ ctx[1];
    			axis0.$set(axis0_changes);
    			const axis1_changes = {};
    			if (dirty & /*yScale*/ 4) axis1_changes.scale = /*yScale*/ ctx[2];
    			axis1.$set(axis1_changes);

    			if (!current || dirty & /*lineGenerator_dead, data*/ 17 && path0_d_value !== (path0_d_value = /*lineGenerator_dead*/ ctx[4](/*data*/ ctx[0]))) {
    				attr_dev(path0, "d", path0_d_value);
    			}

    			if (!current || dirty & /*lineGenerator_recovered, data*/ 33 && path1_d_value !== (path1_d_value = /*lineGenerator_recovered*/ ctx[5](/*data*/ ctx[0]))) {
    				attr_dev(path1, "d", path1_d_value);
    			}

    			if (!current || dirty & /*lineGenerator_ill, data*/ 9 && path2_d_value !== (path2_d_value = /*lineGenerator_ill*/ ctx[3](/*data*/ ctx[0]))) {
    		...
    		i: function intro(local) {
    			...
    			if (!path0_intro) {
    				add_render_callback(() => {
    					path0_intro = create_in_transition(path0, /*reveal*/ ctx[6], { duration: 8000 });
    					path0_intro.start();
    				});
    			}
    			...
    			if (!path1_intro) {
    				add_render_callback(() => {
    					path1_intro = create_in_transition(path1, /*reveal*/ ctx[6], { duration: 8000 });
    					path1_intro.start();
    				});
    			}
    			...
    			if (!path2_intro) {
    				add_render_callback(() => {
    					path2_intro = create_in_transition(path2, /*reveal*/ ctx[6], { duration: 8000 });
    					path2_intro.start();
    				});
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("LineChartCovid", slots, []);
    	let { data } = $$props;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<LineChartCovid> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("lineGenerator_ill" in $$props) $$invalidate(3, lineGenerator_ill = $$props.lineGenerator_ill);
    		if ("lineGenerator_dead" in $$props) $$invalidate(4, lineGenerator_dead = $$props.lineGenerator_dead);
    		if ("lineGenerator_recovered" in $$props) $$invalidate(5, lineGenerator_recovered = $$props.lineGenerator_recovered);
    	};

    	let xScale;
    	let yScale;
    	let lineGenerator_ill;
    	let lineGenerator_dead;
    	let lineGenerator_recovered;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*data*/ 1) {
    			 $$invalidate(1, xScale = time().domain(extent(data, d => new Date(d.Date))).range([margin, width - margin]));
    		}

    		if ($$self.$$.dirty & /*data*/ 1) {
    			 $$invalidate(2, yScale = linear$1().domain([0, max(data, d => +d.daily_sum_ill)]).range([height - margin, margin]));
    		}

    		if ($$self.$$.dirty & /*xScale, yScale*/ 6) {
    			 $$invalidate(3, lineGenerator_ill = line().x(d => xScale(new Date(d.Date))).y(d => yScale(+d.daily_sum_ill)));
    		}

    		if ($$self.$$.dirty & /*xScale, yScale*/ 6) {
    			 $$invalidate(4, lineGenerator_dead = line().x(d => xScale(new Date(d.Date))).y(d => yScale(+d.daily_sum_dead)));
    		}

    		if ($$self.$$.dirty & /*xScale, yScale*/ 6) {
    			 $$invalidate(5, lineGenerator_recovered = line().x(d => xScale(new Date(d.Date))).y(d => yScale(+d.daily_sum_recovered)));
    		}
    	};
    ...
    class LineChartCovid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*data*/ ctx[0] === undefined && !("data" in props)) {
    			console.warn("<LineChartCovid> was created without expected prop 'data'");
    		}
    	}

    	get data() {
    		throw new Error("<LineChartCovid>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set data(value) {
    		throw new Error("<LineChartCovid>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_if_block(ctx) {
    	...
    	linechartcovid = new LineChartCovid({
    			props: { data: /*lineChartData*/ ctx[0] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const linechartcovid_changes = {};
    			if (dirty & /*lineChartData*/ 1) linechartcovid_changes.data = /*lineChartData*/ ctx[0];
    			linechartcovid.$set(linechartcovid_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(linechartcovid.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(linechartcovid.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(linechartcovid);
    		}
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	let main;
    	let current;
    	let if_block = /*lineChartData*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(", ");
    			span1 = element("span");
    			span1.textContent = "recovered";
    			t6 = text(" and ");
    			span2 = element("span");
    			span2.textContent = "dead";
    			t8 = text(" cases");
    			t9 = space();
    			main = element("main");
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "svelte-cxdc6u");
    			...
    			attr_dev(h2, "class", "svelte-cxdc6u");
    			add_location(h2, file$2, 12, 0, 247);
    			attr_dev(main, "class", "svelte-cxdc6u");
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*lineChartData*/ ctx[0]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*lineChartData*/ 1) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let lineChartData;
    	csv$1("fr_daily.csv").then(data => $$invalidate(0, lineChartData = data));
    	...
    	$$self.$capture_state = () => ({ csv: csv$1, LineChartCovid, lineChartData });

    	$$self.$inject_state = $$props => {
    		if ("lineChartData" in $$props) $$invalidate(0, lineChartData = $$props.lineChartData);
    	};
